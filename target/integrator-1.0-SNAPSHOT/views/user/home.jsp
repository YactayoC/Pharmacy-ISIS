    ...
    <nav class="nav container">
        ...
        <div class="nav__menu" id="nav__menu">
            <ul class="nav__list grid">
                <!-- items nav -->
                <li class="nav__item">
                    <a href="${pageContext.request.contextPath}/SCHome?action=list" class="nav__link"><i class="isax isax-home nav__icon"></i>Principal</a>
                </li>
                <li class="nav__item">
            ...
            <c:forEach var="products" items="${products}">
                <div class="offer__content swiper-slide">
                    ...
                    <div class="offer__img">
                        <img src="${pageContext.request.contextPath}/views/admin/assets/img/${products.getUrlPhoto()}" alt="img">
