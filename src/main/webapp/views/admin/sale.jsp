    ...
    <section class="section container sales">
        ...
        <div class="sale container">
            <div class="sale__options options">
                <button class="option option-filter option--active" data-filter="delivery">Delivery
                    <span class="tag-notify tag-notify--primary">8</span>
                </button>
                <button class="option option-filter" data-filter="pick-up">Recogo
                    <span class="tag-notify tag-notify--primary">7</span>
                </button>
                <button class="option option-filter" data-filter="offline">offline
                    <span class="tag-notify tag-notify--primary">7</span>
                </button>
                <a href="${pageContext.request.contextPath}/SAOffline?action=list" class="option sale__btn">
            ...
            <div class="sale__body">
                <!--------- table delivery --------->
                <div class="sale__delivery filter-item " data-tag="delivery">
                    <!-- header of table -->
                ...
                <!--------- table pick up --------->
                <div class="sale__pick-up filter-item hidden" data-tag="pick-up">
                    <!-- header of table -->
                    <ul class="sale__header grid">
                        <li class="sale__header-text sale__total-text">Total productos</li>
                        <li class="sale__header-text">Cliente</li>
                ...
                <!--------- table offline --------->
                <div class="sale__offline filter-item hidden" data-tag="offline">
                    <!-- header of table -->
                    <ul class="sale__header grid">
                        <li class="sale__header-text sale__total-text">Total productos</li>
                        <li class="sale__header-text">Cliente</li>
                    ...
                    <ul class="sale__items grid">
                        ...
                        <!-- client -->
                        <li class="sale__item">
                            <p class="sale__text">Presencial </p>
                        </li>
                        <!-- date -->
                        <li class="sale__item">
                            <p class="sale__text">2020/20/08</p>
