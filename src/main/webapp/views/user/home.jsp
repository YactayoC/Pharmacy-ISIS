            ...
            <nav class="nav container">
                ...
                <div class="nav__menu" id="nav__menu">
                    <ul class="nav__list grid">
                        ...
                        <li class="nav__item">
                            <a href="${pageContext.request.contextPath}/views/user/store.jsp" class="nav__link">
                        ...
                        <c:if test="${validats}">
                         <li class="nav__item">
                          <a href="${pageContext.request.contextPath}/views/user/profile.jsp" class="nav__link btn btn-white"> <!--serlvet -->
            ...
            <section class="hero section">
                <div class="hero__info">
                    ...
                    <div class="hero__about">
                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Praesentium reprehenderit, qui veniam, repellat consectetur ut quod nemo quasi facilis maiores vel eum mollitia porro excepturi aperiam magni libero? Nihil, atque.</p>
                    </div>
                </div>
                <div class="hero__content">
                    <div class="hero__img">
                        <img src="${pageContext.request.contextPath}/views/user/assets/img/mbl-hero-img-1.webp" alt="Mujer con mascarilla">
                        <img src="${pageContext.request.contextPath}/views/user/assets/img/dkt-doctor-woman 1.png" alt="Doctora">
                        <img src="${pageContext.request.contextPath}/views/user/assets/img/dkt-doctor-man 1.png" alt="Doctor">
                    </div>
                    <a class="hero__btn btn btn-secondary">Ver productos</a>
                </div>
            </section>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="offer__content swiper-slide">
                        ...
                        <div class="offer__data">
                            <h2 class="offer__product">Name</h2>
                            <p class="offer__description">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quibusdam, qui.</p>
                            <span class="offer__quantity">25 units</span>
                            <span class="offer__price">$250.00</span>
                            <a href="#" class="offer__btn btn btn-primary">Agregar a carro<i class="isax isax-arrow-right offer__icon"></i></a>
                        </div>
                        <!-- image -->
            ...
            <section class="service section">
                ...
                <div class="service__content">
                    <div class="service__item">
                        <img class="service__img service__delivery" src="${pageContext.request.contextPath}/views/user/assets/img/mbl-service-1.webp" alt="Servicio de delivery">
                        <div class="service__name">Delivery</div>
                    </div>
                    <div class="service__item">
                        <img class="service__img service__medicine" src="${pageContext.request.contextPath}/views/user/assets/img/mbl-service-2.webp" alt="Producto medicos">
                        <div class="service__name">Medicina</div>
                    </div>
                    <div class="service__item">
                        <img class="service__img service__chat" src="${pageContext.request.contextPath}/views/user/assets/img/mbl-service-3.webp" alt="Soporte al cliente">
            ...
            <section class="cards section">
                ...
                <div class="cards__content grid">
                    <div class="cards__svg">
                        ...
                        <path d="M13.3335 33.84L13.5284 33.0603H30.2926C32.6317 33.0603 34.3861 33.84 34.9709 36.3741L38.6746 53.918C34.9709 44.5613 26.3939 36.9589 13.3335 33.84Z" fill="#F9B50B"/>
                        <path d="M62.2613 33.4501L45.3022 73.0212H33.8013L24.0547 39.8828C31.0722 44.3662 36.9202 51.3838 39.0644 56.2571L40.234 60.3506L50.7603 33.2551H62.2613V33.4501Z" fill="#3362AB"/>
                    ...
                    <div class="cards__svg">
                        <svg width="160" height="107" viewBox="0 0 160 107" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0)">
                        <path d="M0 13.3333C0 5.96954 5.96954 0 13.3333 0H146.667C154.03 0 160 5.96954 160 13.3333V93.3333C160 100.697 154.03 106.667 146.667 106.667H13.3333C5.96953 106.667 0 100.697 0 93.3333V13.3333Z" fill="#FDEACE"/>
                        <path d="M96.6928 21.7578L62.2627 21.8762L63.306 84.909L97.7361 84.7906L96.6928 21.7578Z" fill="#FF5F00"/>
